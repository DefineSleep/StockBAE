...
<head>
    ...
    <!--[if gt IE 8]>
    <link href="assets/css/ie/ie9-gallery.css" rel="stylesheet" type="text/css"> <!--<![endif]-->
                    ...
                    <div class="dropdown-menu right top-dropDown-1">
                        ...
                        <ul class="goal-item">
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="goal-user-image">
                                        <img class="rounded" src="assets/images/userimage/avatar3-80.png"
                                             alt="user image"/>
                                    </div>
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="goal-user-image">
                                        <img class="rounded" src="assets/images/userimage/avatar2-80.png"
                                             alt="user image"/>
                                    </div>
                                    <div class="goal-content">
                                        PSD Designe
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="goal-user-image">
                                        <img class="rounded" src="assets/images/userimage/avatar1-80.png"
                                             alt="user image"/>
                                    </div>
                                    <div class="goal-content">
                                        Wordpress PLugin
