...
<head>
    ...
    <title>StockBAE - Browse Markets</title>
    ...
    <!--[if gt IE 8]>
    <link href="http://localhost/StockBAE/public/css/ie/ie9-gallery.css" rel="stylesheet" type="text/css"> <!--<![endif]-->
                    ...
                    <div class="dropdown-menu right top-dropDown-1">
                        ...
                        <ul class="goal-item">
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="goal-user-image">
                                        <img class="rounded" src="http://localhost/StockBAE/public/images/userimage/avatar3-80.png"
                                             alt="user image"/>
                                    </div>
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="goal-user-image">
                                        <img class="rounded" src="http://localhost/StockBAE/public/images/userimage/avatar2-80.png"
                                             alt="user image"/>
                                    </div>
                                    <div class="goal-content">
                                        PSD Designe
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <div class="goal-user-image">
                                        <img class="rounded" src="http://localhost/StockBAE/public/images/userimage/avatar1-80.png"
                                             alt="user image"/>
                                    </div>
                                    <div class="goal-content">
                                        Wordpress PLugin
        ...
        <div id="main-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!--Top header start-->
                        <h3 class="ls-top-header">StockBae Browse Markets</h3>
                        <!--Top header end -->

                        <!--Top breadcrumb start -->
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-home"></i></a></li>
                            <li><a href="#">StockBae Browse Markets</a></li>
                        </ol>
                        <!--Top breadcrumb start -->
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="row filter">
                            ...
                            <div class="row ls-gallery-filter-wrap">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <h3 class="ls-header">Apple Inc.</h3>

                                        <p>
                                                    <span class="about-me-text">NASDAQ: AAPL
                                                    </span>
                                        </p>

                                        <p>Open 41.43&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Market
                                            cap 342.06B <br>High 42.83&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                            &nbsp; &nbsp; &nbsp;P/E ratio (ttm) 17.15 </br>Low 41.33&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Dividend yield 2.92%
                                        </p>
                                        ...
                                        <h3 class="ls-header">Microsoft Corporation</h3>

                                        <p>
                                                    <span class="about-me-text">NASDAQ: MSFT
                                                    </span>
                                        </p>

                                        </p>

                                        <p>Open 128.25&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Market
                                            cap 733.34B <br>High 128.40&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                            &nbsp; &nbsp; &nbsp;P/E ratio (ttm) 16.93 </br>Low 125.16&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Dividend yield 1.49%
                                ...
                                <h3 class="ls-header">Samsung Electronics Co Ltd</h3>

                                <p>
                                                    <span class="about-me-text">KRX: 005930
                                                    </span>
                                </p>

                                </p>

                                <p>Open 1,449,000&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Market cap
                                    236.17T <br>High 1,452,000 &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
                                    &nbsp; &nbsp;P/E ratio (ttm) 9.41 </br>Low 1,430,000 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Dividend yield 1.39%
                        ...
                        <h3 class="ls-header">Hewlett-Packard</h3>

                        <p>
                                                    <span class="about-me-text">NYSE: HPQ
                                                    </span>
                        </p>

                        <p>Open 31.88&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Market cap 57.23B <br>High
                            31.98&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;P/E ratio (ttm)
                            12.08 </br>Low 31.48&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Dividend
                            yield 2.03%
                        </p>
