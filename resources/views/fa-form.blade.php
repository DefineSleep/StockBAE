...
<head>
    ...
    <title>StockBae - Enter FA Details</title>
        ...
        <div id="main-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!--Top header start-->
                        <h3 class="ls-top-header">Enter FA Details</h3>
                        <!--Top header end -->

                        <!--Top breadcrumb start -->
                        <ol class="breadcrumb">
                            <li><a href="#"><i class="fa fa-home"></i></a></li>
                            <li class="active">FA Form</li>
                        </ol>
                        <!--Top breadcrumb start -->
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Enter FA Details</h3>
                            </div>
                                    ...
                                    <div class="panel-body form_view">
                                        ...
                                        <form id="formID" class="formular form-horizontal ls_form" method="post"
                                            ...
                                            <div class="row ls_divider">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label"> Salary/hr:*</label>
                    ...
                    <div class="setting-box-content">
                        <ul>
                            <li><span class="pull-left">Online status: </span><input type="checkbox"
                                                                                     class="js-switch-red" checked/>
                            </li>
                            <li><span class="pull-left">Show offline contact: </span><input type="checkbox"
                                                                                            class="js-switch-light-blue"
                                                                                            checked/></li>
                            <li><span class="pull-left">Invisible mode: </span><input class="js-switch" type="checkbox"
                                                                                      checked></li>
