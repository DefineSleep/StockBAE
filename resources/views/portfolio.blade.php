                                ...
                                <li>
                                    <a href="javascript:void(0)">
                                        <div class="goal-user-image">
                                            <img class="rounded" src="http://localhost/StockBAE/public/images/userimage/bm.png" alt="user image" />
                                        </div>
...
<div class="row">
    <div class="col-md-12">
        <!--Top header start-->
        <h3 class="ls-top-header">Portfolio</h3>
        <!--Top header end -->
    ...
    <div class="col-md-9">
        <div class="memberBox">
            ...
            <div id="realTimeChart" class="flotChartRealTime widgetRealTime">
                <img src="graph.png" style="width:100%; height: 200px;">
            </div>
            <div class="memberBox-details">
                <ul>
                    <li>
                        ...
                        <div class="memberBox-value up"><i class="fa fa-user"></i> <span>4</span></div>
                    </li>
                    <li>
                        <div class="memberBox-title">
                            <i class="fa fa-eye"></i>
                    ...
                    <li>
                        ...
                        <div class="memberBox-value up"><i class="fa  fa-money"></i> <span>$4,120,040</span></div>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <li>
                                    <a href="javascript:void(0)">
                                        <div class="recent-activities">
                                            Meeting <div>Rescheduled meeting 2 days ago..</div>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <div class="recent-activities">
                                            Shares Sold <div>Sold shares worth $240,000 4 days ago..</div>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                        <div class="recent-activities">
                                            Shares bought <div> Bought shares from Sony 4 days ago..</div>
                                        </div>
                                    </a>
                                </li>
                                <li class="only-link">
...
<!--Layout Script start -->
    ...
    <script type="text/javascript" src="http://localhost/StockBAE/public/js/pages/demo.flotchart.js"></script>
