                            ...
                            <div class="col-md-12">
                                <div class="mail-area">
                                    ...
                                    <div class="panel-body form_view">
                                        ...
                                        <form id="formID" class="formular form-horizontal ls_form" method="post" action="http://localhost/StockBAE/public/client/edit">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control" name="fa_id"
                                                                id="fa_id">
                                                            <option selected value="{{ $client[$i]->fa_id}}">{{ $client[$i]->fname}}</option>
                                                            ...
                                                            <option value="zx5">Zain Ali</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text"
                                                               ...
                                                               id="c_id" value="{{ $client[$i]->c_id}}"
                                                               name="c_id" placeholder="ab123" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row ls_divider">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="password"
                                                               class="form-control text-input"
                                                               id="password" value="{{ $client[$i]->password}}"
                                            ...
                                            <div class="row ls_divider">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input placeholder="someone@nowhere.com" value="{{ $client[$i]->email}}"
                                                               class="form-control"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea placeholder="Enter Your Home Address"
                                                                  ...
                                                                  id="address">{{ $client[$i]->address}} </textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row ls_divider">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input placeholder="1985/08/31" value="{{ $client[$i]->dob}}"
                                                               class="form-control text-input"
                                                               type="date" name="dob"
                                                               id="dob"/>
                                            ...
                                            <div class="row ls_divider">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input placeholder="056832634" value="{{ $client[$i]->contact_no}}"
                                                               class="form-control"
                                            ...
                                            <div class="row ls_divider">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input placeholder="123456789" value="{{ $client[$i]->account_no}}"
                                                               class="form-control"
                                            ...
                                            <div class="row ls_divider">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input placeholder="123456789" value="{{ $client[$i]->ni_no}}"
                                                               class="form-control"
