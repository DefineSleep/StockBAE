        ...
        <div id="main-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!--Top header start-->
                        <h3 class="ls-top-header">About Us</h3>
                        <!--Top header end -->
                        <div class="row">
                    ...
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="ls-user-info col-md-8 col-sm-7">
                            <div class="ls-user-text">
                                <p>At StockBAE, our mission is to partner with you to create financial comfort, help and
                                    protect your family, and build a legacy. We are driven to provide objective,
                                    tailored solutions that enhance your life.

                                    We are committed to maintaining the highest standards of integrity and
                                    professionalism in our relationship with you, our client. We endeavor to know and
                                    understand your financial situation and provide you with only the highest quality
                                    service and advice to help you reach your personal goals.</p>
