...
<!-- Mirrored from fickle.aimmate.com/flotchart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Jan 2015 13:50:42 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <section id="left-navigation">
            ...
            <li class="active">
                ...
                <ul>
                    ...
                    <li><a class="active" href="flotchart.html">Flot</a>
                    </li>
                    <li>
            ...
            <div id="main-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <!--Top header start-->
                            <h3 class="ls-top-header">Flot Chart</h3>
                            <!--Top header end -->
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="paiChartAction">
                                        ...
                                        <p id="description"></p>
                                        <button class="btn btn-info btn-sm" id="example-1">Default Options</button>
                                        <button class="btn btn-info btn-sm" id="example-2">Without Legend</button>
                                        <button class="btn btn-info btn-sm" id="example-3">Label Formatter</button>
                                        <button class="btn btn-info btn-sm" id="example-4">Label Radius</button>
                                        <button class="btn btn-info btn-sm" id="example-5">Label Styles #1</button>
                                        <button class="btn btn-info btn-sm" id="example-6">Label Styles #2</button>
                                        <button class="btn btn-info btn-sm" id="example-7">Hidden Labels</button>
                                        <button class="btn btn-info btn-sm" id="example-8">Combined Slice</button>
                                        <button class="btn btn-info btn-sm" id="example-9">Rectangular Pie</button>
                                        <button class="btn btn-info btn-sm" id="example-10">Tilted Pie</button>
                                        <button class="btn btn-info btn-sm" id="example-11">Donut Hole</button>
                                        <button class="btn btn-info btn-sm" id="example-12">Interactivity</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Toggle Chart</h3>
                                </div>
                                <div class="panel-body">
                                    <div id="seriesToggle" class="seriesToggle" style=""></div>
                                    <ul id="choices"></ul>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from fickle.aimmate.com/flotchart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Jan 2015 13:50:43 GMT -->
</html>