...
<!-- Mirrored from fickle.aimmate.com/red-color.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Jan 2015 13:59:58 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="red-color"> <!--- Put active red-color in here for red layout at default---->
                ...
                <li class="active">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#">Color</a>
                            <ul>
                                <li><a class="active" href="red-color.html">Red</a></li>
                ...
                <div id="main-content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!--Top header start-->
                                <h3 class="ls-top-header">Red Layout</h3>
                                <!--Top header end -->
