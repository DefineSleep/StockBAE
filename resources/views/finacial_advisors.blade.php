            ...
            <div id="main-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <!--Top header start-->
                            <h3 class="ls-top-header">Financial Advisors</h3>
                            <!--Top header end -->
                                    ...
                                    <!-- ls Gallery Container Start -->
                                        <div id="grid" class="m-row shuffle--container shuffle--fluid">
                                            <!-- ls Gallery Item Start -->
                                                <div class="col-md-6 col-sm-6 col-xs-12 m-col-md-6 picture-item" data-groups='["project"]'
                                            ...
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-6 col-sm-6 col-xs-12 m-col-md-6 picture-item" data-groups='["design","task"]'
                                            ...
                                            <!-- ls Gallery Item Finish -->
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-6 col-sm-6 col-xs-12 m-col-md-6 picture-item" data-groups='["psd"]'
                                            ...
                                            <!-- ls Gallery Item Finish -->
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-6 col-sm-6 col-xs-12 m-col-md-6 picture-item" data-groups='["design"]'
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 shuffle__sizer"></div>
                                            <!-- ls Gallery Item Responsive Call Start -->
                                        </div>
