            ...
            <div id="main-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <!--Top header start-->
                            <h3 class="ls-top-header">StockBae Client Directory</h3>
                            <!--Top header end -->

                            <!--Top breadcrumb start -->
                            <ol class="breadcrumb">
                                <li><a href="#"><i class="fa fa-home"></i></a></li>
                                <li><a href="#">StockBae Client Directory</a></li>
                            </ol>
                            <!--Top breadcrumb start -->
                        </div>
                    </div>
                                ...
                                <div class="row ls-gallery-filter-wrap">
                                    <div class="col-md-6 ls-gallery-paddingless-wrap">
                                        ...
                                        <div class="filter-options">
                                            <button class="btn btn--warning" data-group="design">All Clients</button>
                                            <button class="btn btn--warning" data-group="psd">Recent Clients</button>
                                            <button class="btn btn--warning" data-group="project">Top Grossing Clients</button>
                                    ...
                                    <div class="col-md-12 ls-gallery-paddingless-wrap">
                                        ...
                                        <div id="grid" class=" m-row shuffle--container shuffle--fluid">
                                            <!-- ls Gallery Item Start -->
                                                <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 picture-item" data-groups='["project"]'
                                                        data-date-created="2010-09-14" data-title="Baseball">
                                                    <div class="picture-item__inner">
                                                        <!-- Gallery Hover Wrap Start -->
                                                        <div class="ls-hover-block ls-three-column-icon ls-block-effect">
                                                            <!-- Image Path Start -->
                                                            <img src="assets/images/gallery/lady-type-460x290.png" alt="image">
                                                            <!-- Image Path Finish -->
                                                            <div class="ls-blind"></div>
                                                                <div class="ls-hover-info ls-three-column-icon">
                                                                    ...
                                                                    <div class="ls-icons-preview ls-gallery-image-view" data-rel="imageGallery">
                                                                        <a href="javascript:void(0);" data-src="assets/images/gallery/lady-type-460x290.png"><i class="fa fa-search"></i></a>
                                                                    </div>
                                                        ...
                                                        <div class="picture-item__details clearfix">
                                                            <div class="picture-item__title pull-left">
                                                                <a href="javascript:void(0);">Coming Soon</a>
                                                            </div>
                                                            <p class="picture-item__tags pull-right">Project</p>
                                                        </div>
                                            ...
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 picture-item" data-groups='["design","task"]'
                                                 data-date-created="2011-08-14" data-title="Tennis">
                                                <div class="picture-item__inner">
                                                    <div class="ls-hover-block ls-block-effect">
                                                        ...
                                                        <div class="ls-hover-info ls-three-column-icon">
                                                            ...
                                                            <div class="ls-icons-preview ls-gallery-image-view" data-rel="imageGallery">
                                                                <a  href="javascript:void(0);"  data-src="assets/images/gallery/iphone-hand-460x290.png"><i class="fa fa-search"></i></a>
                                                            </div>
                                                            <div class="ls-icons-remove">
                                                                <a href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
                                                            </div>
                                                    ...
                                                    <div class="picture-item__details clearfix">
                                                        ...
                                                        <p class="picture-item__tags pull-right">Design, Task</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- ls Gallery Item Finish -->
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 picture-item" data-groups='["design","task"]'
                                                 data-date-created="2009-05-27" data-title="iMac">
                                                <div class="picture-item__inner">
                                                    <div class="ls-hover-block ls-block-effect">
                                                        ...
                                                        <div class="ls-hover-info ls-three-column-icon">
                                                            ...
                                                            <div class="ls-icons-preview ls-gallery-image-view" data-rel="imageGallery">
                                                                <a href="javascript:void(0);"  data-src="assets/images/gallery/iphone-diary-460x290.png"><i class="fa fa-search"></i></a>
                                                            </div>
                                                            <div class="ls-icons-remove">
                                                                <a href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
                                                            </div>
                                            ...
                                            <!-- ls Gallery Item Finish -->
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 picture-item" data-groups='["psd"]'
                                                 data-date-created="2012-05-14" data-title="Master Chief">
                                                <div class="picture-item__inner">
                                                    <div class="ls-hover-block ls-block-effect">
                                                        ...
                                                        <div class="ls-hover-info ls-three-column-icon">
                                                            ...
                                                            <div class="ls-icons-preview ls-gallery-image-view" data-rel="imageGallery">
                                                                <a  href="javascript:void(0);"  data-src="assets/images/gallery/i-phone5s-460x290.png"><i class="fa fa-search"></i></a>
                                                            </div>
                                                            <div class="ls-icons-remove">
                                                                <a href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
                                                            </div>
                                                    ...
                                                    <div class="picture-item__details clearfix">
                                                        ...
                                                        <p class="picture-item__tags pull-right">PSD</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- ls Gallery Item Finish -->
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 picture-item" data-groups='["design","task"]'
                                                 data-date-created="2009-09-14" data-title="Eightfold">
                                                <div class="picture-item__inner">
                                                    <div class="ls-hover-block ls-block-effect">
                                                        ...
                                                        <div class="ls-hover-info ls-three-column-icon">
                                                            ...
                                                            <div class="ls-icons-preview ls-gallery-image-view" data-rel="imageGallery">
                                                                <a  href="javascript:void(0);"  data-src="assets/images/gallery/glass-mac-460x290.png"><i class="fa fa-search"></i></a>
                                                            </div>
                                                            <div class="ls-icons-remove">
                                                                <a href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
                                                            </div>
                                                    ...
                                                    <div class="picture-item__details clearfix">
                                                        <div class="picture-item__title pull-left">
                                                            <a href="javascript:void(0);">500 Error</a>
                                                        </div>
                                                        <p class="picture-item__tags pull-right">Design, Task</p>
                                                    </div>
                                                </div>
                                            ...
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 picture-item" data-groups='["project"]'
                                                 data-date-created="2012-03-14" data-title="Pumpkin">
                                                <div class="picture-item__inner">
                                                    <div class="ls-hover-block ls-block-effect">
                                                        ...
                                                        <div class="ls-hover-info ls-three-column-icon">
                                                            ...
                                                            <div class="ls-icons-preview ls-gallery-image-view" data-rel="imageGallery">
                                                                <a  href="javascript:void(0);"  data-src="assets/images/gallery/dj-mix-460x290.png"><i class="fa fa-search"></i></a>
                                                            </div>
                                                            <div class="ls-icons-remove">
                                                                <a href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
                                                            </div>
                                                    ...
                                                    <div class="picture-item__details clearfix">
                                                        <div class="picture-item__title pull-left">
                                                            <a href="javascript:void(0);">Mobile Login</a>
                                                        </div>
                                                        <p class="picture-item__tags pull-right">Project</p>
                                                    </div>
                                                </div>
                                            ...
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 picture-item" data-groups='["design","task"]'
                                                 data-date-created="2013-05-19" data-title="Vestride">
                                                <div class="picture-item__inner">
                                                    <div class="ls-hover-block ls-block-effect">
                                                        ...
                                                        <div class="ls-hover-info ls-three-column-icon">
                                                            ...
                                                            <div class="ls-icons-preview  ls-gallery-image-view" data-rel="imageGallery">
                                                                <a  href="javascript:void(0);"  data-src="assets/images/gallery/diacelar-460x290.png"><i class="fa fa-search"></i></a>
                                                            </div>
                                                            <div class="ls-icons-remove">
                                                                <a href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
                                                            </div>
                                            ...
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 picture-item" data-groups='["psd"]'
                                                 data-date-created="2013-02-01" data-title="Newegg">
                                                <div class="picture-item__inner">
                                                    <div class="ls-hover-block ls-block-effect">
                                                        ...
                                                        <div class="ls-hover-info ls-three-column-icon">
                                                            ...
                                                            <div class="ls-icons-preview ls-gallery-image-view" data-rel="imageGallery">
                                                                <a  href="javascript:void(0);"  data-src="assets/images/gallery/connector-460x290.png"><i class="fa fa-search"></i></a>
                                                            </div>
                                                            <div class="ls-icons-remove">
                                                                <a href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
                                                            </div>
                                                    ...
                                                    <div class="picture-item__details clearfix">
                                                        <div class="picture-item__title pull-left">
                                                            <a href="javascript:void(0);">Newegg</a></div>
                                                        <p class="picture-item__tags pull-right">PSD</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- ls Gallery Item Finish -->
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 picture-item" data-groups='["design"]'
                                                 data-date-created="2000-01-01" data-title="Arc">
                                                <div class="picture-item__inner">
                                                    <div class="ls-hover-block ls-block-effect">
                                                        ...
                                                        <div class="ls-hover-info ls-three-column-icon">
                                                            ...
                                                            <div class="ls-icons-preview ls-gallery-image-view" data-rel="imageGallery">
                                                                <a  href="javascript:void(0);"  data-src="assets/images/gallery/car-iphone-460x290.png"><i class="fa fa-search"></i></a>
                                                            </div>
                                                            <div class="ls-icons-remove">
                                                                <a href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
                                                            </div>
                                                    ...
                                                    <div class="picture-item__details clearfix">
                                                        <div class="picture-item__title pull-left">
                                                            <a href="javascript:void(0);">Arc</a>
                                                        </div>
                                                        <p class="picture-item__tags pull-right">design</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- ls Gallery Item Finish -->
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 picture-item" data-groups='["project"]'
                                                 data-date-created="2012-07-04" data-title="Ground">
                                                <div class="picture-item__inner">
                                                    <div class="ls-hover-block ls-block-effect">
                                                        ...
                                                        <div class="ls-hover-info ls-three-column-icon">
                                                            ...
                                                            <div class="ls-icons-preview ls-gallery-image-view" data-rel="imageGallery">
                                                                <a  href="javascript:void(0);"  data-src="assets/images/gallery/camera-lense-460x290.png"><i class="fa fa-search"></i></a>
                                                            </div>
                                                            <div class="ls-icons-remove">
                                                                <a href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
                                                            </div>
                                                    ...
                                                    <div class="picture-item__details clearfix">
                                                        <div class="picture-item__title pull-left">
                                                            <a href="javascript:void(0);">Ground</a></div>
                                                        <p class="picture-item__tags pull-right">project</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- ls Gallery Item Start -->
                                            <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 picture-item" data-groups='["design"]'
                                                 data-date-created="2011-08-12" data-title="Grass">
                                                <div class="picture-item__inner">
                                                    <div class="ls-hover-block ls-block-effect">
                                                        ...
                                                        <div class="ls-hover-info ls-three-column-icon">
                                                            ...
                                                            <div class="ls-icons-preview ls-gallery-image-view" data-rel="imageGallery">
                                                                <a  href="javascript:void(0);" data-src="assets/images/gallery/camera-460x290.png"><i class="fa fa-search"></i></a>
                                                            </div>
                                                            <div class="ls-icons-remove">
                                                                <a href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
                                                            </div>
                                                    ...
                                                    <div class="picture-item__details clearfix">
                                                        <div class="picture-item__title pull-left">
                                                            <a href="javascript:void(0);">Grass</a>
                                                        </div>
                                                        <p class="picture-item__tags pull-right">design</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 picture-item" data-groups='["design","task"]'
                                                ...
                                                <div class="picture-item__inner">
                                                    <div class="ls-hover-block ls-block-effect">
                                                        ...
                                                        <div class="ls-blind"></div>
                                                        <div class="ls-hover-info ls-three-column-icon ls-gallery-image-view">
                                                            <div class="ls-icons-link">
                                                                <a href="javascript:void(0);"><i class="fa fa-link"></i></a>
                                                            </div>
                                                            <div class="ls-icons-preview  ls-gallery-image-view" data-rel="imageGallery">
                                                                <a  href="javascript:void(0);" data-src="assets/images/gallery/book-table-460x290.png"><i class="fa fa-search"></i></a>
                                                            </div>
                                                            <div class="ls-icons-remove">
                                                                <a href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
                                                            </div>
                                                    ...
                                                    <div class="picture-item__details clearfix">
                                                        <div class="picture-item__title pull-left">
                                                            <a href="javascript:void(0);">Vestride</a></div>
                                                        <p class="picture-item__tags pull-right">design, task</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12 m-col-md-4 shuffle__sizer"></div>
                                            <!-- ls Gallery Item Responsive Call Start -->
                                        </div>
